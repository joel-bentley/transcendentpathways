...
var FacilityTable = React.createClass({
    ...
    showDetails: function showDetails(facilityNew) {
        this.setState({
            showResults: true,
            facility: facilityNew
        });
    },
    renderOffset: function renderOffset(offset) {
        this.setState({
            offset: offset
        });
    },
    ...
    getCSRFTokenValue: function getCSRFTokenValue() {
    ...
    handleChangedData: function handleChangedData(facility) {
    ...
    render: function render() {
        ...
        this.state.facilities.forEach((function (facility) {
            if (facility.approved != false) {
                rowsApproved.push(React.createElement(FacilityRow, {
                    facility: facility,
                ...
                rowsNotApproved.push(React.createElement(FacilityRow, {
                    facility: facility,
                    key: facility.facilityName,
                    showDetails: this.showDetails,
                    renderOffset: this.renderOffset
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'col-sm-8' },
                    this.state.showResults && !this.state.showNotes ? React.createElement(DetailsBar, {
                ...
                React.createElement(
                    'div',
                    { className: 'col-sm-8' },
                    this.state.showNotes ? React.createElement(ListContainer, {
                        offset: this.state.offset,
...
React.render(React.createElement(FacilityTable, null), document.getElementById("facilityAdmin"));

},{"../notes/ListContainer.jsx":182,"./DetailsBar.jsx":177,"./FacilityRow.jsx":179,"react/addons":4}],2:[function(require,module,exports){
...
var DetailsBar = React.createClass({
    ...
    placeDiv: function placeDiv(x_pos, y_pos) {
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: 'col-sm-12 slideTransition' },
            React.createElement(
                'div',
                null,
                React.createElement(FacilityFields, { fieldValues: this.props.facility,
...
},{"./FacilityFields.jsx":178,"react":176}],178:[function(require,module,exports){
"use strict";

var React = require('react');

var FacilityFields = React.createClass({
    displayName: "FacilityFields",

    render: function render() {
        return React.createElement(
            "div",
            { className: this.props.fieldValues.approved ? "panel panel-default" : "panel panel-primary" },
            React.createElement(
                "div",
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "button",
                                {
                                    className: this.props.fieldValues.approved ? "btn btn-primary btn-sm " : "btn btn-default btn-sm",
                                    type: "button",
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "address1",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "address2",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "zipcode",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "contactName",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "contactPhone",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "contactEmail",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "buildingName",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "locationName",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "roomSize",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "select",
                                    { className: "form-control", defaultValue: this.props.fieldValues.securityNeeded,
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "select",
                                    { className: "form-control", defaultValue: this.props.fieldValues.waiverNeeded,
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "patientNumber",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "approvedDate",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "signUpDate",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { className: "col-sm-8" },
                                React.createElement("input", { type: "text", className: "form-control", ref: "approvedBy",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "select",
                                    { className: "form-control", defaultValue: this.props.fieldValues.approved,
    ...
    saveAndContinue: function saveAndContinue(event) {
        event.preventDefault();
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            {
                                type: "button",
                                className: this.props.facility.approved ? "btn btn-sm btn-default " : "btn btn-sm btn-primary",
...
var AddItem = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: 'panel panel-default notePanel' },
            React.createElement(
                'div',
                { className: 'form-group' },
                React.createElement(
...
var List = React.createClass({
    ...
    render: function render() {
        var listItems = this.props.items.map((function (item, index) {
            return React.createElement(
                'div',
                { className: 'container-fluid ', key: item.noteDate },
                React.createElement(
                    'div',
                    { className: ' adminNotes' },
                    React.createElement(
                        'div',
                        { className: 'row ' },
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'em',
                                    null,
                                    moment.utc(item.noteDate).format('dddd MMMM D, YYYY')
                                )
                            )
                        ),
                        React.createElement(
                            'div',
                            { className: 'col-sm-1 buttonRow' },
                            React.createElement(
                                'button',
                                {
...
},{"moment":3,"react":176}],182:[function(require,module,exports){
'use strict';
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: this.props.approved ? "panel-default" : "panel-primary" },
                    React.createElement(
                        'div',
                        { className: 'panel-heading' },
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        'button',
                                        {
                                            className: this.props.approved ? "btn btn-primary btn-sm" : "btn btn-default btn-sm",
                                            type: 'button',
                                            onClick: this.props.showNotes },
                                        React.createElement(
                                            'span',
...
},{"./AddItem.jsx":180,"./List.jsx":181,"react":176}]},{},[1]);
