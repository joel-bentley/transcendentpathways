...
var EventContainer = React.createClass({
    ...
    enableSave: function enableSave(state) {
        this.setState({
            enableSave: state
        });
    },
    ...
    componentDidMount: function componentDidMount() {
        //csh loading the events into this.state.events
    ...
    showDetails: function showDetails(eventNew) {
        this.setState({
            showResults: true,
            event: eventNew
        });
    ...
    render: function render() {
        ...
        this.state.events.forEach((function (event) {
            if (!event.status.completed && !event.status.canceled) {
                upcomingEvents.push(React.createElement(EventCard, {
                    event: event,
                    key: event._id,
                ...
                completeEvents.push(React.createElement(EventCard, {
                    event: event,
                    key: event._id,
                    showDetails: this.showDetails,
                    enableSave: this.enableSave,
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'col-sm-8 ' },
                        this.state.showResults ? React.createElement(StatusCard, {
...
React.render(React.createElement(EventContainer, null), document.getElementById("eventAdmin"));

},{"./EventCard.jsx":161,"./StatusCard.jsx":165,"react":158}],2:[function(require,module,exports){
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'h5',
                    null,
                    'Event Approved For (click note to approve)'
                ),
                this.props.event.approvedMusicianName ? React.createElement(
                    'div',
            ...
            this.props.allowSave ? React.createElement(
                'div',
                { className: 'row' },
                React.createElement('hr', null),
                React.createElement(
                    'div',
                    { className: 'col-sm-1 col-sm-11-offset' },
                    React.createElement(
                        'button',
                        {
...
var EventCard = React.createClass({
    ...
    getFacilityInfo: function getFacilityInfo(facilityName) {
        $.ajaxSetup({
            headers: {
                'X-CSRF-Token': this.getCSRFTokenValue()
            }
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-sm-2' },
                            this.props.allowSave ? null : React.createElement(
                                'button',
                                {
                                    type: 'button',
                                    className: 'btn btn-sm btn-primary',
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-sm-9 col-sm-3-offset' },
                            React.createElement(
                                'span',
                                null,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'h5',
                            null,
                            startString + '  -  ' + endString + ' (' + timeDiffString + ' minutes)'
                        )
                    ),
                    React.createElement(
                        'div',
                    ...
                    this.state.complete ? React.createElement(FacilityContact, { facility: this.state.facility }) : null
                )
            )
        );
    }
...
},{"./FacilityContact.jsx":162,"moment":3,"react":158}],162:[function(require,module,exports){
"use strict";

var React = require('react');

var FacilityContact = React.createClass({
    displayName: "FacilityContact",
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    "div",
                    { className: "col-xs-10 col-xs-offset-3" },
                    React.createElement(
                        "h5",
                        null,
                        "Phone ",
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'col-sm-6' },
                        React.createElement('input', { className: 'form-control', type: 'text', ref: 'paymentStatus',
                            disabled: true,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'col-sm-6', style: { "position": "relative" } },
                        React.createElement(
                            'fieldset',
                            null,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'col-sm-6' },
                        React.createElement('input', { type: 'text', className: 'form-control', ref: 'paymentReference',
                            disabled: this.props.event.status.completed || this.props.event.status.canceled,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'col-sm-2 col-sm-offset-9' },
                        React.createElement(
                            'div',
                            null,
                            this.props.event.status.completed || this.props.event.status.canceled ? null : React.createElement(
                                'button',
                                { className: 'btn btn-sm btn-primary',
                                    onClick: this.saveAndContinue },
                                'Submit'
...
var RequestedBy = React.createClass({
    ...
    updateMusician: function updateMusician(musician) {
    ...
    render: function render() {
        ...
        this.props.musicians.map((function (elem) {
            if (elem) {
                musicianList.push(React.createElement(
                    "li",
                    { className: "list-group-item", key: elem.musicianName + elem.musicianId },
                    React.createElement(
                        "div",
                        { className: "row" },
                        React.createElement(
                        ...
                        this.props.event.status.completed ? null : React.createElement(
                            "div",
                            { className: "col-sm-2" },
                            React.createElement("span", {
...
var StatusCard = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            'div',
            { className: 'panel panel-default slideTransition' },
            React.createElement(
                'div',
                { className: 'panel-heading' },
                React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-sm-2 ', style: { 'textAlign': 'center' } },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-sm-6' },
                            React.createElement(RequestedBy, {
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-sm-6' },
                            React.createElement(ApprovedMusician, {
                                event: this.props.event,
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-sm-10 col-sm-1-offset' },
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'col-sm-10 col-sm-1-offset' },
                            React.createElement(CancelEvent, {
                                event: this.props.event,
                                updateEvent: this.props.updateEvent,
                                enableSave: this.props.enableSave
                            })
...
},{"./ApprovedMusician.jsx":159,"./CancelEvent.jsx":160,"./PaymentStatus.jsx":163,"./RequestedBy.jsx":164,"./StatusIndicator.jsx":166,"moment":3,"react":158}],166:[function(require,module,exports){
'use strict';
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    this.props.status ? React.createElement('span', { className: 'glyphicon glyphicon-ok', style: { color: 'green' } }) : null
                )
            )
        );
    }
